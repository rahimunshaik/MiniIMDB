...
// this is Api key I get it from IMDb website(IMDb Api)
...
// access Element by DOM Api and stores element in variable 
...
function apiCall(url) {
    ...
    x.send();
    // Once the request is sent, then I can use the event handlers to handle XHR object responses.
    x.onload = function () {
        container.innerHTML="";
        var res = x.response;
        // resp to JSON data 
